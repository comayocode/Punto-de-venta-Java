...
public class ProveedorControladorAgregar implements ActionListener{
    ...
    public ProveedorControladorAgregar(ProveedorVO vo, ProveedorDAO dao, frmProveedoresAgregar vista) {
        this.vo = vo;
        this.dao = dao;
        this.vista = vista;
