...
import vista.frmVentasLista;
import static vista.frmVentasLista.tbListaVentas;


public class pintarVentasLista {
    public static void pintar(){
        try {
            ...
            tbListaVentas.setDefaultRenderer(Double.class, c); 
            tbListaVentas.setDefaultRenderer(String.class, c); 
            tbListaVentas.setDefaultRenderer(Integer.class, c);
                       
            //Colorear celdas
            for (int i = 0; i<frmVentasLista.tbListaVentas.getColumnCount(); i++){
                tbListaVentas.getColumnModel().getColumn(i).setCellRenderer(c);
            }
    ...
    public static void editarHeaderJtable(){
        JTableHeader header = tbListaVentas.getTableHeader();
        header.setFont(new Font("Roboto", Font.BOLD, 16));
        header.setForeground(new Color(0xF1F1F1));
        header.setOpaque(false);
        tbListaVentas.getTableHeader().setBackground(new Color(0x100F0F));
    }
}
