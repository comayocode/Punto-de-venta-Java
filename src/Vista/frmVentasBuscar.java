...
import utilidades.jtable.pintar_tablas.pintarVentasBuscar;

public class frmVentasBuscar extends javax.swing.JFrame {
    ...
    public frmVentasBuscar() {
        ...
        pintarVentasBuscar.pintar();
        pintarVentasBuscar.editarHeaderJtable();
    }
    ...
    private void initComponents() {
        ...
        tbBuscarVenta = new javax.swing.JTable();
        ...
        txtCodigoVenta.setBackground(new java.awt.Color(217, 217, 217));
        txtCodigoVenta.setFont(new java.awt.Font("Roboto Medium", 0, 15)); // NOI18N
        txtCodigoVenta.setBorder(null);
        jpBuscarCompra.add(txtCodigoVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 20, 117, 25));
        ...
        txtFechaVenta.setBackground(new java.awt.Color(217, 217, 217));
        txtFechaVenta.setFont(new java.awt.Font("Roboto Medium", 0, 15)); // NOI18N
        txtFechaVenta.setBorder(null);
        txtFechaVenta.setOpaque(true);
        jpBuscarCompra.add(txtFechaVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 125, 140, 25));
        ...
        jpBuscarCompra.add(txtIdCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 140, 25));
        ...
        jpBuscarCompra.add(txtCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 125, 140, 25));
        ...
        tbBuscarVenta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbBuscarVenta.setRowHeight(25);
        tbBuscarVenta.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tbBuscarVenta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVentasBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVentasBuscar().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tbBuscarVenta;
