...
public class frmClientesModificar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        header.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(55, 17, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmClientesModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmClientesModificar().setVisible(true);
            }
        });
    }
