...
public class frmVentasMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnAñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 224, 55));
        ...
        jPanel2.add(btnCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 224, 55));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/compras/Buscar.png"))); // NOI18N
    ...
    private void btnAñadirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAñadirMouseClicked
        frmVentasAgregar añadir = new frmVentasAgregar();
    ...
    private void btnCargarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCargarMouseClicked
        frmVentasBuscar buscar = new frmVentasBuscar();
    ...
    private void btnListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnListaMouseClicked
        frmVentasLista lista = new frmVentasLista();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVentasMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVentasMenu().setVisible(true);
            }
        });
    }
