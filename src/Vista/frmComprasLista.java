...
import utilidades.jtable.pintar_tablas.pintarComprasLista;

public class frmComprasLista extends javax.swing.JFrame {

    int xMouse, yMouse;

    public frmComprasLista() {
        initComponents();
        this.setLocationRelativeTo(null);
        pintarComprasLista.pintar();
        pintarComprasLista.editarHeaderJtable();
    }
    ...
    private void initComponents() {
        ...
        lbTittle.setText("Lista de Compras");
        ...
        tbListaCompras.setRowHeight(25);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmComprasLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmComprasLista().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tbListaCompras;
