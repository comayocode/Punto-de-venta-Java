 ...
 * @author ronal
 */
public class frmClientesEliminar extends javax.swing.JFrame {
    /*
    ...
    */
    ...
    public void codigoPresionado() {
        if (txtCedulaCliente.getText().equals("Cédula")) { //Si el campo tiene "Código"...
            txtCedulaCliente.setText(""); //Quita el texto
            txtCedulaCliente.setForeground(new Color(0x100F0F)); //Cambia de color la letra
        }
    ...
    public void proveedorPresionado() {
        ...
        if (txtCedulaCliente.getText().isEmpty()) {
            txtCedulaCliente.setText("Cédula");
            txtCedulaCliente.setForeground(new Color(0x666666));
        }
    }
    ...
    private void initComponents() {
        ...
        txtCedulaCliente.setBackground(new java.awt.Color(241, 241, 241));
        txtCedulaCliente.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        ...
        txtCedulaCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtCedulaClienteMousePressed(evt);
            }
        });
        ...
        body.add(txtCedulaCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(52, 25, 190, 21));
    ...
    private void txtCedulaClienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtCedulaClienteMousePressed
        codigoPresionado();
    }//GEN-LAST:event_txtCedulaClienteMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmClientesEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmClientesEliminar().setVisible(true);
            }
        });
    }
